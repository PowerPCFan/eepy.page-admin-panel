...
@section('content')
    <x-panel class="grid gap-5 mt-10 p-6">
        ...
        >
            @csrf
            <a
                class="rounded-lg border border-border px-4 py-2 text-sm w-[18ch] text-center"
            ...
            >
                <x-slot:trigger><x-button type="button" class="w-[18ch]" variant="danger">Terminate session</x-button></x-slot:trigger>

...
@section('content')
  ...
  <h2 class="mb-3 text-xl font-semibold">Material icons</h2>
  <div class="mb-8 flex flex-col gap-2">
    <x-materialsymbols icon="manage-accounts" size="24px" />
    <x-materialsymbols icon="construction" size="24px" />
    <x-materialsymbols icon="logout" size="24px" />
  </div>
